...
import com.xworkz.january.boot.entity.FilmEntity;
...
public class FilmJPARunner {
    public static void main(String[] args) {
        ...
        FilmEntity filmEntity = new FilmEntity(1,"KATERA","DARSHAN","ARADHANA","ROCKLINE","TARUN");
